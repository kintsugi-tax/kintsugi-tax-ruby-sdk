...
module KintsugiSDK
  ...
  class SDKConfiguration
    ...
    sig { returns(::KintsugiSDK::SDKHooks::Hooks) }
    attr_accessor :hooks

    sig { returns(T.nilable(::KintsugiSDK::Utils::RetryConfig)) }
    ...
    def initialize(client, hooks, retry_config, timeout_ms, security, security_source, server_url, server_idx)
      ...
      @sdk_version = '5.4.0'
      @gen_version = '2.674.1'
      @user_agent = 'speakeasy-sdk/ruby 5.4.0 2.674.1 1.0.0 kintsugi_sdk'
    end
