  ...
  module Models
    module Shared
      ...
      class TaxItemBuilder
        ...
        field :rate, ::Float, { 'format_json': { 'letter_case': ::KintsugiSDK::Utils.field_name('rate'), required: true } }
        ...
        sig { params(rate: ::Float, amount: ::Float, name: ::String, organization_id: ::String, converted_amount: T.nilable(::Float), currency: T.nilable(Models::Shared::CurrencyEnum), destination_currency: T.nilable(Models::Shared::CurrencyEnum), external_id: T.nilable(::String), type: T.nilable(Models::Shared::TaxItemTypeEnum), jurisdiction_type: T.nilable(Models::Shared::JurisdictionType), jurisdiction_name: T.nilable(::String), rule_id: T.nilable(::String)).void }
        def initialize(rate:, amount:, name:, organization_id:, converted_amount: nil, currency: nil, destination_currency: nil, external_id: nil, type: nil, jurisdiction_type: nil, jurisdiction_name: nil, rule_id: '0000')
          @rate = rate
          @amount = amount
          @name = name
