  ...
  module Models
    module Shared
      ...
      class CustomerBaseBase
        ...
        field :is_test_data, Crystalline::Nilable.new(Crystalline::Boolean.new), { 'format_json': { 'letter_case': ::KintsugiSDK::Utils.field_name('is_test_data') } }

        sig { params(organization_id: ::String, phone: T.nilable(::String), street_1: T.nilable(::String), street_2: T.nilable(::String), city: T.nilable(::String), county: T.nilable(::String), state: T.nilable(::String), postal_code: T.nilable(::String), country: T.nilable(Models::Shared::CountryCodeEnum), full_address: T.nilable(::String), name: T.nilable(::String), external_id: T.nilable(::String), status: T.nilable(Models::Shared::StatusEnum), email: T.nilable(::String), address_status: T.nilable(Models::Shared::AddressStatus), source: T.nilable(Models::Shared::SourceEnum), registration_number: T.nilable(::String), connection_id: T.nilable(::String), enriched_fields: T.nilable(::String), is_test_data: T.nilable(T::Boolean)).void }
        def initialize(organization_id:, phone: nil, street_1: nil, street_2: nil, city: nil, county: nil, state: nil, postal_code: nil, country: nil, full_address: nil, name: nil, external_id: nil, status: nil, email: nil, address_status: nil, source: nil, registration_number: nil, connection_id: nil, enriched_fields: nil, is_test_data: false)
