  ...
  module Models
    module Shared
      ...
      class PageProductRead
        ...
        field :items, Crystalline::Array.new(Models::Shared::ProductRead), { 'format_json': { 'letter_case': ::KintsugiSDK::Utils.field_name('items'), required: true } }
        ...
        sig { params(items: T::Array[Models::Shared::ProductRead], total: ::Integer, page: ::Integer, size: ::Integer, pages: T.nilable(::Integer)).void }
