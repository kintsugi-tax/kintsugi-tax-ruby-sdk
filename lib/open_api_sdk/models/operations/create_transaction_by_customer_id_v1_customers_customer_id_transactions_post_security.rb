...
module OpenApiSDK
  module Models
    module Operations
      ...
      class CreateTransactionByCustomerIdV1CustomersCustomerIdTransactionsPostSecurity
        extend T::Sig
        ...
        def ==(other)
          ...
          T.cast(other, CreateTransactionByCustomerIdV1CustomersCustomerIdTransactionsPostSecurity)
