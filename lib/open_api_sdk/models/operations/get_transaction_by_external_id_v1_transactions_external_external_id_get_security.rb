...
module OpenApiSDK
  module Models
    module Operations
      ...
      class GetTransactionByExternalIdV1TransactionsExternalExternalIdGetSecurity
        extend T::Sig
        ...
        def ==(other)
          ...
          T.cast(other, GetTransactionByExternalIdV1TransactionsExternalExternalIdGetSecurity)
