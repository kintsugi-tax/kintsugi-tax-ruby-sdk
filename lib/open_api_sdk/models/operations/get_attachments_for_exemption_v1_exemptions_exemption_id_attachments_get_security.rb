...
module OpenApiSDK
  module Models
    module Operations
      ...
      class GetAttachmentsForExemptionV1ExemptionsExemptionIdAttachmentsGetSecurity
        extend T::Sig
        ...
        def ==(other)
          ...
          T.cast(other, GetAttachmentsForExemptionV1ExemptionsExemptionIdAttachmentsGetSecurity)
