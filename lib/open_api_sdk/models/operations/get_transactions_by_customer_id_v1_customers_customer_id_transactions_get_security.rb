...
module OpenApiSDK
  module Models
    module Operations
      ...
      class GetTransactionsByCustomerIdV1CustomersCustomerIdTransactionsGetSecurity
        extend T::Sig
        ...
        def ==(other)
          ...
          T.cast(other, GetTransactionsByCustomerIdV1CustomersCustomerIdTransactionsGetSecurity)
