  ...
  module Models
    module Components
      ...
      class PageProductRead
        ...
        field :items, T::Array[Models::Components::ProductRead], { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('items'), required: true } }
        ...
        sig { params(items: T::Array[Models::Components::ProductRead], total: T.nilable(::Integer), page: T.nilable(::Integer), size: T.nilable(::Integer), pages: T.nilable(::Integer)).void }
