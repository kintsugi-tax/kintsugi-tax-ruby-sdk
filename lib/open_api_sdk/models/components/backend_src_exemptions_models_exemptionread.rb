  ...
  module Models
    module Components
      ...
      class BackendSrcExemptionsModelsExemptionRead
        ...
        field :attachment_id, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('attachment_id') } }

        sig { params(exemption_type: Models::Components::ExemptionType, start_date: ::Date, id: ::String, jurisdiction: T.nilable(::String), country_code: T.nilable(Models::Components::CountryCodeEnum), end_date: T.nilable(::Date), customer_id: T.nilable(::String), transaction_id: T.nilable(::String), reseller: T.nilable(T::Boolean), fein: T.nilable(::String), sales_tax_id: T.nilable(::String), status: T.nilable(Models::Components::ExemptionStatus), customer_name: T.nilable(::String), attachment_id: T.nilable(::String)).void }
        ...
        def ==(other)
          ...
          T.cast(other, BackendSrcExemptionsModelsExemptionRead)
