  ...
  module Models
    module Components
      ...
      class TransactionEstimateRequestAddress
        ...
        #                         SHIP_TO or BILL_TO.
        field :type, Models::Components::TransactionEstimateRequestType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('type'), required: true, 'decoder': Utils.enum_from_string(Models::Components::TransactionEstimateRequestType, false) } }
        ...
        sig { params(type: Models::Components::TransactionEstimateRequestType, state: ::String, postal_code: ::String, country: ::String, phone: T.nilable(::String), street_1: T.nilable(::String), street_2: T.nilable(::String), city: T.nilable(::String), county: T.nilable(::String), full_address: T.nilable(::String), status: T.nilable(::String), enriched_fields: T.nilable(::String)).void }
        ...
        def ==(other)
          ...
          T.cast(other, TransactionEstimateRequestAddress)
