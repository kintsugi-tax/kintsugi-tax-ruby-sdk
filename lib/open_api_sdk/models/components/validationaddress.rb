  ...
  module Models
    module Components
      ...
      class ValidationAddress
        ...
        field :line3, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('line3') } }
        ...
        field :postal_code, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('postalCode') } }
        ...
        def ==(other)
          ...
          T.cast(other, ValidationAddress)
