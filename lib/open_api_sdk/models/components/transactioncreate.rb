  ...
  module Models
    module Components
      ...
      class TransactionCreate
        ...
        field :addresses, T::Array[Models::Components::TransactionAddressBuilder], { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('addresses'), required: true } }

        field :transaction_items, T::Array[Models::Components::TransactionItemCreateUpdate], { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('transaction_items'), required: true } }
        ...
        # Imported tax amount.
        field :total_tax_amount_imported, T.nilable(T.any(::Float, ::String)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('total_tax_amount_imported') } }
        # Imported tax rate.
        ...
        field :total_tax_amount_calculated, T.nilable(T.any(::Float, ::String)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('total_tax_amount_calculated') } }
        # Calculated tax rate.
        ...
        field :total_tax_liability_amount, T.nilable(T.any(::Float, ::String)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('total_tax_liability_amount') } }
        # Taxable amount.
        ...
        field :converted_total_amount, T.nilable(T.any(::Float, ::String)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('converted_total_amount') } }
        # Converted imported tax amount.
        field :converted_total_tax_amount_imported, T.nilable(T.any(::Float, ::String)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('converted_total_tax_amount_imported') } }
        # Converted calculated tax amount.
        field :converted_total_tax_amount_calculated, T.nilable(T.any(::Float, ::String)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('converted_total_tax_amount_calculated') } }
        # Currency conversion rate.
        field :conversion_rate, T.nilable(T.any(::Float, ::String)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('conversion_rate') } }
        ...
        field :converted_total_tax_liability_amount, T.nilable(T.any(::Float, ::String)), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('converted_total_tax_liability_amount') } }

        field :customer, T.nilable(Models::Components::CustomerCreate), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('customer') } }

        sig { params(organization_id: ::String, external_id: ::String, date: ::DateTime, addresses: T::Array[Models::Components::TransactionAddressBuilder], transaction_items: T::Array[Models::Components::TransactionItemCreateUpdate], status: T.nilable(Models::Components::TransactionStatusEnum), total_amount: T.nilable(T.any(::Float, ::String)), total_tax_amount_imported: T.nilable(T.any(::Float, ::String)), tax_rate_imported: T.nilable(T.any(::Float, ::String)), total_tax_amount_calculated: T.nilable(T.any(::Float, ::String)), tax_rate_calculated: T.nilable(T.any(::Float, ::String)), total_tax_liability_amount: T.nilable(T.any(::Float, ::String)), taxable_amount: T.nilable(T.any(::Float, ::String)), currency: T.nilable(Models::Components::CurrencyEnum), source: T.nilable(Models::Components::SourceEnum), address_status: T.nilable(Models::Components::AddressStatus), processing_status: T.nilable(Models::Components::ProcessingStatusEnum), requires_exemption: T.nilable(Models::Components::ExemptionRequired), shop_date: T.nilable(::Date), shop_date_tz: T.nilable(::String), description: T.nilable(::String), refund_status: T.nilable(Models::Components::TransactionRefundStatus), customer_id: T.nilable(::String), marketplace: T.nilable(T::Boolean), exempt: T.nilable(Models::Components::TransactionExemptStatusEnum), exemptions: T.nilable(T::Array[Models::Components::Exemption]), related_to: T.nilable(::String), secondary_external_id: T.nilable(::String), secondary_source: T.nilable(::String), external_friendly_id: T.nilable(::String), tax_liability_source: T.nilable(Models::Components::TaxLiabilitySourceEnum), locked: T.nilable(T::Boolean), connection_id: T.nilable(::String), filing_id: T.nilable(::String), city: T.nilable(::String), county: T.nilable(::String), state: T.nilable(::String), country: T.nilable(Models::Components::CountryCodeEnum), postal_code: T.nilable(::String), tax_id: T.nilable(::String), destination_currency: T.nilable(Models::Components::CurrencyEnum), converted_total_amount: T.nilable(T.any(::Float, ::String)), converted_total_tax_amount_imported: T.nilable(T.any(::Float, ::String)), converted_total_tax_amount_calculated: T.nilable(T.any(::Float, ::String)), conversion_rate: T.nilable(T.any(::Float, ::String)), converted_taxable_amount: T.nilable(T.any(::Float, ::String)), converted_total_discount: T.nilable(T.any(::Float, ::String)), converted_subtotal: T.nilable(T.any(::Float, ::String)), converted_total_tax_liability_amount: T.nilable(T.any(::Float, ::String)), customer: T.nilable(Models::Components::CustomerCreate)).void }
        def initialize(organization_id:, external_id:, date:, addresses:, transaction_items:, status: nil, total_amount: nil, total_tax_amount_imported: nil, tax_rate_imported: nil, total_tax_amount_calculated: nil, tax_rate_calculated: nil, total_tax_liability_amount: nil, taxable_amount: nil, currency: nil, source: nil, address_status: nil, processing_status: nil, requires_exemption: nil, shop_date: nil, shop_date_tz: nil, description: nil, refund_status: nil, customer_id: nil, marketplace: nil, exempt: nil, exemptions: nil, related_to: nil, secondary_external_id: nil, secondary_source: nil, external_friendly_id: nil, tax_liability_source: nil, locked: false, connection_id: nil, filing_id: nil, city: nil, county: nil, state: nil, country: nil, postal_code: nil, tax_id: nil, destination_currency: nil, converted_total_amount: nil, converted_total_tax_amount_imported: nil, converted_total_tax_amount_calculated: nil, conversion_rate: nil, converted_taxable_amount: nil, converted_total_discount: nil, converted_subtotal: nil, converted_total_tax_liability_amount: nil, customer: nil)
        ...
        def ==(other)
          ...
          T.cast(other, TransactionCreate)
