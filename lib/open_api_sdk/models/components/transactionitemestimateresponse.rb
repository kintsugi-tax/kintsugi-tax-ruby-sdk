  ...
  module Models
    module Components
      ...
      class TransactionItemEstimateResponse
        ...
        field :tax_items, T.nilable(T::Array[Models::Components::TaxItemEstimate]), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('tax_items') } }
        ...
        field :tax_amount, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('tax_amount') } }
        ...
        field :tax_rate, T.nilable(::String), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('tax_rate') } }
        # Reason for exemption, if applicable.
        field :exempt_reason, T.nilable(Models::Components::TaxExemptionEnum), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('exempt_reason'), 'decoder': Utils.enum_from_string(Models::Components::TaxExemptionEnum, true) } }

        sig { params(date: ::DateTime, amount: ::String, tax_items: T.nilable(T::Array[Models::Components::TaxItemEstimate]), external_id: T.nilable(::String), description: T.nilable(::String), external_product_id: T.nilable(::String), product_name: T.nilable(::String), product_description: T.nilable(::String), product_source: T.nilable(Models::Components::SourceEnum), product_subcategory: T.nilable(Models::Components::ProductSubCategoryEnum), product_category: T.nilable(Models::Components::ProductCategoryEnum), quantity: T.nilable(::String), exempt: T.nilable(T::Boolean), tax_amount: T.nilable(::String), taxable_amount: T.nilable(::String), tax_rate: T.nilable(::String), exempt_reason: T.nilable(Models::Components::TaxExemptionEnum)).void }
        def initialize(date:, amount:, tax_items: nil, external_id: nil, description: nil, external_product_id: nil, product_name: nil, product_description: nil, product_source: nil, product_subcategory: nil, product_category: nil, quantity: '1.0', exempt: false, tax_amount: '0.00', taxable_amount: '0.00', tax_rate: '0.00', exempt_reason: nil)
          @date = date
          @amount = amount
          @tax_items = tax_items
        ...
        def ==(other)
          ...
          T.cast(other, TransactionItemEstimateResponse)
