  ...
  module Models
    module Components
      ...
      class TransactionAddressPublic
        ...
        sig { params(type: Models::Components::AddressType, phone: T.nilable(::String), street_1: T.nilable(::String), street_2: T.nilable(::String), city: T.nilable(::String), county: T.nilable(::String), state: T.nilable(::String), postal_code: T.nilable(::String), country: T.nilable(Models::Components::CountryCodeEnum), full_address: T.nilable(::String), enriched_fields: T.nilable(::String)).void }
        def initialize(type:, phone: nil, street_1: nil, street_2: nil, city: nil, county: nil, state: nil, postal_code: nil, country: nil, full_address: nil, enriched_fields: nil)
          @type = type
          @phone = phone
          @street_1 = street_1
          @street_2 = street_2
        ...
        def ==(other)
          ...
          T.cast(other, TransactionAddressPublic)
