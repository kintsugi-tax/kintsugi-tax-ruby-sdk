  ...
  module Models
    module Components
      ...
      class CustomerCreate
        ...
        def initialize(status: nil, address_status: nil, phone: nil, street_1: nil, street_2: nil, city: nil, county: nil, state: nil, postal_code: nil, country: nil, full_address: nil, name: nil, external_id: nil, email: nil, source: nil, connection_id: nil, registration_number: nil)
          @status = status
