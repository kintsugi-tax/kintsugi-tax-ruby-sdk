  ...
  module Models
    module Components
      ...
      class PageCustomerRead
        ...
        field :items, T::Array[Models::Components::CustomerRead], { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('items'), required: true } }
        ...
        sig { params(items: T::Array[Models::Components::CustomerRead], total: T.nilable(::Integer), page: T.nilable(::Integer), size: T.nilable(::Integer), pages: T.nilable(::Integer)).void }
