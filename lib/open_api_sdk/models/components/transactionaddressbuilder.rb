  ...
  module Models
    module Components
      ...
      class TransactionAddressBuilder
        ...
        sig { params(type: Models::Components::AddressType, status: T.nilable(Models::Components::AddressStatus), phone: T.nilable(::String), street_1: T.nilable(::String), street_2: T.nilable(::String), city: T.nilable(::String), county: T.nilable(::String), state: T.nilable(::String), postal_code: T.nilable(::String), country: T.nilable(Models::Components::CountryCodeEnum), full_address: T.nilable(::String), enriched_fields: T.nilable(::String), organization_id: T.nilable(::String)).void }
        def initialize(type:, status: nil, phone: nil, street_1: nil, street_2: nil, city: nil, county: nil, state: nil, postal_code: nil, country: nil, full_address: nil, enriched_fields: nil, organization_id: nil)
          @type = type
          @status = status
          @phone = phone
          @street_1 = street_1
        ...
        def ==(other)
          ...
          T.cast(other, TransactionAddressBuilder)
