  ...
  module Models
    module Components
      ...
      class PageTransactionRead
        ...
        field :items, T::Array[Models::Components::TransactionRead], { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('items'), required: true } }
        ...
        sig { params(items: T::Array[Models::Components::TransactionRead], total: T.nilable(::Integer), page: T.nilable(::Integer), size: T.nilable(::Integer), pages: T.nilable(::Integer)).void }
        ...
        def ==(other)
          ...
          T.cast(other, PageTransactionRead)
