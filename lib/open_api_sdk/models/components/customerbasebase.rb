  ...
  module Models
    module Components
      ...
      class CustomerBaseBase
        ...
        field :is_test_data, T.nilable(T::Boolean), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('is_test_data') } }

        sig { params(organization_id: ::String, status: T.nilable(Models::Components::StatusEnum), address_status: T.nilable(Models::Components::AddressStatus), phone: T.nilable(::String), street_1: T.nilable(::String), street_2: T.nilable(::String), city: T.nilable(::String), county: T.nilable(::String), state: T.nilable(::String), postal_code: T.nilable(::String), country: T.nilable(Models::Components::CountryCodeEnum), full_address: T.nilable(::String), name: T.nilable(::String), external_id: T.nilable(::String), email: T.nilable(::String), source: T.nilable(Models::Components::SourceEnum), registration_number: T.nilable(::String), connection_id: T.nilable(::String), enriched_fields: T.nilable(::String), is_test_data: T.nilable(T::Boolean)).void }
        def initialize(organization_id:, status: nil, address_status: nil, phone: nil, street_1: nil, street_2: nil, city: nil, county: nil, state: nil, postal_code: nil, country: nil, full_address: nil, name: nil, external_id: nil, email: nil, source: nil, registration_number: nil, connection_id: nil, enriched_fields: nil, is_test_data: false)
        ...
        def ==(other)
          ...
          return false unless @is_test_data == other.is_test_data
          true
        end
      end
    end
