...
module OpenApiSDK
  ...
  class TaxEstimation
    ...
    sig { params(security: Models::Operations::EstimateTaxV1TaxEstimatePostSecurity, transaction_estimate_request: Models::Components::TransactionEstimateRequest, x_organization_id: T.nilable(::String), simulate_nexus_met: T.nilable(T::Boolean), timeout_ms: T.nilable(Integer)).returns(Models::Operations::EstimateTaxV1TaxEstimatePostResponse) }
    def estimate_tax(security:, transaction_estimate_request:, x_organization_id:, simulate_nexus_met: nil, timeout_ms: nil)
      ...
      request = Models::Operations::EstimateTaxV1TaxEstimatePostRequest.new(
      ...
      req_content_type, data, form = Utils.serialize_request_body(request, false, false, :transaction_estimate_request, :json)
      ...
      query_params = Utils.get_query_params(Models::Operations::EstimateTaxV1TaxEstimatePostRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::PageTransactionEstimateResponse)
          response = Models::Operations::EstimateTaxV1TaxEstimatePostResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            page_transaction_estimate_response: T.unsafe(obj)
          )
        ...
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Errors::BackendSrcTaxEstimationResponsesValidationErrorResponse)
          obj.raw_response = http_response
          throw obj
        else
          raise ::OpenApiSDK::Models::Errors::APIError.new(status_code: http_response.status, body: http_response.env.response_body, raw_response: http_response), 'Unknown content type received'
